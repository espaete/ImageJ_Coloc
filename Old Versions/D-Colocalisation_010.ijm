...
function quantifyLabeling(staining, minSize, circularity, holes, segment){
...
quantifyLabeling(nucleus, minNucleusSize, nucleusCircularity, holes1, segment1);
quantifyLabeling(cellType, minCellSize, cellCircularity, holes2, segment2);
quantifyLabeling(protein, minLabelingSize, labelingCircularity, holes3, segment3);
