...
while(quantify){
	...
	while (notSatisfied) {
		...
		Dialog.create("Settings");
			...
			Dialog.addCheckbox("Recursive thresholding", true);
	   	...
	   	doRecursive = Dialog.getCheckbox();
		segment = Dialog.getCheckbox();
	   	fillHoles = Dialog.getCheckbox();
	   	isClose = Dialog.getCheckbox();
		...
		notSatisfied = getBoolean("Repeat quantification or continue with next one?", "Repeat", "Continue");
