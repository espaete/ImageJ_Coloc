...
#@ String (label="Staining 1", value="DAPI") nucleus
#@ String (label= "Nuclear labeling?:", choices={"Yes", "No"}, style = "listBox") stainingForm1
...
#@ String (label="Staining 2", value="CA2") cellType
#@ String (label= "Nuclear labeling?:", choices={"Yes", "No"}, style = "listBox") stainingForm2
...
#@ String (label= "Nuclear labeling?:", choices={"No", "Yes"}, style = "listBox") stainingForm3
#@ String (label="Staining 3", value="LDHA") protein
...
function quantifyLabeling(staining, stainingForm, minSize, maxSize, circularity, holes, segment){
...
//Quantifies colocalisation by overlapping the corresponding labeling masks
	...
	run("Invert");
	selectWindow("Mask-" + staining2);
	run("Duplicate...", "title=RawMask-" + staining2 + "+" + staining1);
	run("Invert");
	run("Restore Selection");
	run("Clear", "slice");
	run("Select None");
...
quantifyLabeling(nucleus, stainingForm1, minNucleusSize, maxNucleusSize, nucleusCircularity, holes1, segment1);
quantifyLabeling(cellType, stainingForm2, minCellSize, maxCellSize, cellCircularity, holes2, segment2);
quantifyLabeling(protein, stainingForm3, minLabelingSize, maxLabelingSize, labelingCircularity, holes3, segment3);
