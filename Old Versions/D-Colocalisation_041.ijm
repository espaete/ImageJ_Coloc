...
//Quantifies colocalisation by overlapping the corresponding masks created by "quantifyLabeling".
	if(matches(stainingA, "\\w+.*") && matches(stainingB, "\\w+.*")){
		if(isOpen("Mask-" + stainingB + "+" + stainingA)){
			...
			if(isOpen(stainingA + "_" + areaName + "_raw") && isOpen(stainingB + "_" + areaName + "_raw")){
				...
				run("Outline");
				run("16-bit");
				run("Merge Channels...", "c1=" + stainingA + "_" + areaName + "_noBG c2=" + stainingB + "_" + areaName + "_noBG c3=" + stainingA + "_" + areaName + "_raw c4=" + stainingB + "_" + areaName + "_raw c5=Outlines-" + stainingA + "+" + stainingB + " create keep");
				...
				run("Select None");
				setForegroundColor(0, 0, 0);
				run("Duplicate...", "title=Mask-" + stainingA + "+" + stainingB + " duplicate channels=5");
...
if(matches(staining1, ".+") && matches(staining2, ".+") && matches(staining3, ".+")){
	run("Merge Channels...", "c1=" + allStainings[0] + "_" + areaName + "_raw c2=" + allStainings[1] +"_" + areaName + "_raw c3="  + allStainings[2] + "_" + areaName + "_raw c4=Outlines-"  + allStainings[0] +  " c5=Outlines-"  + allStainings[1] +  " c6=Outlines-"  + allStainings[2] + " c7=Outlines-" + allStainings[0] + "+" + allStainings[1] + "+" + allStainings[2] +  " create keep");
}
