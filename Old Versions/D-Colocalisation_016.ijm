...
//Quantifies colocalisation by overlapping the corresponding labeling masks
	if(matches(stainingA, ".+") && matches(stainingB, ".+\\+.+")){
...
if(matches(staining1, ".+") && matches(staining2, "") && matches(staining3, "")){
	...
	run("Merge Channels...", "c1=" + staining1 + "_" + areaName + "_raw c2=" + staining2 +"_" + areaName + "_raw c3=Outlines-"  + staining1 +  " c4=Outlines-"  + staining2 + " create keep");
	
}else if(matches(staining1, ".+") && matches(staining2, ".+") && matches(staining3, ".+")){
	run("Merge Channels...", "c1=" + staining1 + "_" + areaName + "_raw c2=" + staining2 +"_" + areaName + "_raw c3="  + staining3 + "_" + areaName + "_raw" + "c4=Outlines-"  + staining1 +  " c4=Outlines-"  + staining2 +  " c5=Outlines-"  + staining3 + " create keep");
}
...
run("Merge Channels...", "c1=C1-" + areaName + " C2-" + areaName + " C3-" + areaName + " C4-" + areaName + "c5=Outlines-"  + staining1 +  " c6=Outlines-"  + staining2 +  " c7=Outlines-"  + staining3 + " create"));