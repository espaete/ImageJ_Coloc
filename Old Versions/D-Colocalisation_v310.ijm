...
function createCompoundImage(stainingA, stainingB){	
	...
	run("Merge Channels...", "c1=" + stainingA  + "_raw c2=" + stainingB  + "_raw c3=Outlines-" + stainingA + " c4=Outlines-" + stainingB + " c5=" + stainingB + "-ParticlesOutlines c6=" + stainingA + "-Mask create keep");
