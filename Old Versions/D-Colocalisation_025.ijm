...
#@ Float (label="Coloc Circularity (low = less stringent):", style="slider", min=0, max=1, stepSize=0.01) circularityColoc
...
quantifyColoc(staining1, staining2, minSize1, maxSize1, circularityColoc, fillHoles1, segment1);
quantifyColoc(staining1, staining3, minSize1, maxSize1, circularityColoc, fillHoles1, segment1);
quantifyColoc(staining2, staining3, minSize2, maxSize2, circularityColoc, fillHoles2, segment2);
